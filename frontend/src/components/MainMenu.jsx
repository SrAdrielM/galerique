    ...
    return (
      <div className="bg-white border-b shadow-sm">
        <div className="container mx-auto flex space-x-10 px-4">
          ...
          <a href="#" className="py-4 text-gray-600 hover:text-gray-900">Cuadros</a>
          <a href="#" className="py-4 text-gray-600 hover:text-gray-900" onClick={() => navigate('/SobreNos/')}>Sobre Nostros</a>
